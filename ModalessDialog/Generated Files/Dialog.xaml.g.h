...
namespace winrt::ModalessDialog::implementation
{
    ...
    struct DialogT : public ::winrt::ModalessDialog::implementation::Dialog_base<D,
        ::winrt::Microsoft::UI::Xaml::Markup::IComponentConnector,
        I...>
    {
        using base_type = typename DialogT::base_type;
        using base_type::base_type;
        using class_type = typename DialogT::class_type;
