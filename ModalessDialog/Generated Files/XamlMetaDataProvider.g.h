...
namespace winrt::ModalessDialog::implementation
{
    ...
    struct __declspec(empty_bases) XamlMetaDataProvider_base : implements<D, ModalessDialog::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = ModalessDialog::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"ModalessDialog.XamlMetaDataProvider";
        }
    };
}
namespace winrt::ModalessDialog::factory_implementation
{
    ...
    {
        using instance_type = ModalessDialog::XamlMetaDataProvider;
