...
namespace winrt::ModalessDialog::implementation
{
    ...
    void DialogT<D, I...>::InitializeComponent()
    {
        if (!_contentLoaded)
        {
            _contentLoaded = true;
            ::winrt::Windows::Foundation::Uri resourceLocator{ L"ms-appx:///Dialog.xaml" };
            ::winrt::Microsoft::UI::Xaml::Application::LoadComponent(*this, resourceLocator, ComponentResourceLocation::Application);
        }
    }

    template <typename D, typename ... I>
    void DialogT<D, I...>::Connect(int32_t connectionId, IInspectable const& target)
    {
        switch (connectionId)
        {
        case 1:
            {
                auto targetElement = target.as<::winrt::Microsoft::UI::Xaml::Window>();
                auto weakThis = ::winrt::make_weak<class_type>(*this);
                targetElement.Closed([weakThis](::winrt::Windows::Foundation::IInspectable const& p0, ::winrt::Microsoft::UI::Xaml::WindowEventArgs const& p1){
                    if (auto t = weakThis.get())
                    {
                        ::winrt::get_self<D>(t)->OnEvent_Closed(p0, p1);
                    }
                });
            }
            break;
    ...
    template <typename D, typename ... I>
    void DialogT<D, I...>::DisconnectUnloadedObject(int32_t)
    {
        throw ::winrt::hresult_invalid_argument { L"No unloadable objects to disconnect." };
    }

    template <typename D, typename ... I>
    void DialogT<D, I...>::UnloadObject(DependencyObject const&)
    {
    ...
    template <typename D, typename... I>
    IComponentConnector DialogT<D, I...>::GetBindingConnector(int32_t, IInspectable const&)
    {
        return nullptr;
    }

    template struct DialogT<struct Dialog>;
}
