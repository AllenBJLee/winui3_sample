        ...
        namespace Packages
        {
            ...
            namespace DDLM
            {
                public class X86
                {
                    ...
                    public const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.3000.882.2207.0-x8_8wekyb3d8bbwe";
                }
                public class X64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for x64.
                    public const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.3000.882.2207.0-x6_8wekyb3d8bbwe";
                }
                public class Arm64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for arm64.
                    public const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.3000.882.2207.0-a6_8wekyb3d8bbwe";
                }
            }
        }
    }
